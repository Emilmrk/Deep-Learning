...
model.save('fer2013_resnet50_finetuned_extra.h5')
...
plt.tight_layout()
plt.savefig('graficos/grafico_entrenamiento_resnet50_finetune_extra.png')
plt.close()
...
plt.title("Matriz de Confusión ResNet50 (Fine-Tuned + Extra)")
plt.savefig('graficos/matriz_confusion_resnet50_finetune_extra.png')
plt.close()
